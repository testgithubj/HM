...
export default function ComplaintDashboard() {
  ...
  console.log('in complaint dashboard ', complaintId);
  ...
  return (
    <>
      <AddComplaint open={openAdd} handleClose={handleCloseAdd} />
                  ...
                  <Item sx={{ height: '100%' }}>
                    ...
                    <Grid container spacing={2} sx={{ justifyContent: 'between', alignItems: 'center', marginTop: '1px' }}>
                      ...
                      <Grid item xs={6} md={6}>
                        ...
                        >
                          {complaintData.description ? complaintData.description : 'N/A'}
                        </Typography>
                      </Grid>
                    </Grid>
                  </Item>
