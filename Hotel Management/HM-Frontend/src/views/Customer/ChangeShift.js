...
const ChangeShift = (props) => {
  const { open, handleClose, data, id } = props;
  const initialValues = {
    shift: data || 'default'
  };

  const UpdateShiftTime = async (values, resetForm) => {
    try {
      let response = await patchApi(`api/employee/edit/${id}`, values);
            ...
            <Grid item xs={12} sm={12} md={10}>
              <FormControl fullWidth>
                ...
                >
                  ...
                  <MenuItem value="morning(4AM-10AM)">Morning- 4:00 AM -10:00 AM </MenuItem>
                  <MenuItem value="day(10AM-4PM)">Day- 10:00 AM -4:00 PM </MenuItem>
                  <MenuItem value="evening(4PM-10PM)">Evening- 4:00 PM -10:00 PM </MenuItem>
                  <MenuItem value="night(10PM-4AM)</">Day- 10:00 PM -4:00 AM </MenuItem>
                </Select>
              </FormControl>
            </Grid>
          </Grid>
